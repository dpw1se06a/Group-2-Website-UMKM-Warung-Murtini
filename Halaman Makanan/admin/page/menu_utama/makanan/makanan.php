                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="tambahDataMakananLabel">
                                                Tambah Makanan
                                            </h1>
                                        </div>
                                ...
                                <tbody>
                                    <?php
                                                ...
                                                foreach ($data as $row) {
                                                    ?>
                                    <tr>
                                        <td><img src="image/<?= $row['gambar'] ?>" width="200px"></td>
                                        <td><?= $row['nama_makanan'] ?></td>
                                        <td><?= $row['deskripsi'] ?></td>
                                        <td>Rp. <?= number_format($row['harga'], 0, ',', '.') ?></td>
                                        <td>
                                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#editDataMakanan">Edit</button>
                                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#hapusDataMakanan">Hapus</button>
                                        </td>
                                    </tr>

                                    <!-- MODAL EDIT -->
                                    <div class="modal" id="editDataMakanan<?= $row['id_makanan'] ?>" tabindex="-1"
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5"
                                                        id="editDataMakananx<?= $row['id_makanan'] ?>Label">
                                                        Edit <?= $row['nama_makanan'] ?>
                                                    </h1>
                                                </div>
                                                <form method="POST" action="menu_utama/makanan/proses/proses_ubah.php">
                                                    <div class="modal-body">
                                                        <input type="text" class="form-control" id="id_makanan"
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="nama_makanan" class="form-label">Nama
                                                                Makanan</label>
                                                            <input type="text" class="form-control" id="nama_makanan"
                                                                name="nama_makanan" value="<?= $row['nama_makanan'] ?>">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="deskripsi" class="form-label">Deskripsi</label>
                                                            <input type="text" class="form-control" id="deskripsi"
                                    ...
                                    <!-- MODAL DELETE -->
                                    <div class="modal" id="hapusDataMakanan<?= $row['id_makanan'] ?>" tabindex="-1"
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5"
                                                        ...
                                                        Hapus <?= $row['nama_makanan'] ?>
                                                    </h1>
                                                </div>
                                                <form method="POST" action="menu_utama/makanan/proses/proses_hapus.php">
                                                    <div class="modal-body">
                                                        <input type="text" class="form-control" id="id_makanan"
                                                            name="id_makanan" value="<?= $row['id_makanan'] ?>"
                                                            hidden="true">
                        ...
                        <div class="card-header">
                            ...
                            <div class="modal fade" id="tambahDataPesanMakanan" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="tambahDataPesanMakananLabel">
                                                Tambah Pesanan
                                            </h1>
                                        </div>
                                        <form method="POST" action="menu_utama/makanan/proses/proses_tambah.php">
                        ...
                        <div class="card-body">
                            <table id="List" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <!-- Modal ubah data -->
                                    <div class="modal fade" id="editDataPesanModal<?= $data['user_id'] ?>" tabindex="-1"
                                        role="dialog" aria-labelledby="editDataPesanModalLabel" ariahidden="true">
