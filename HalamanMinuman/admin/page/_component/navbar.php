...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="page.php?mod=dashboard" class="brand-link">
    <img src="../../src/admin/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light">AdminLTE 3.2</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="page.php?mod=dashboard" class="d-block">GROUP 2</a>
      </div>
    </div>
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="page.php?mod=mari makan" class="nav-link">
            <i class="nav-icon fas fa-circle"></i>
            <p>
              Mari makan
            </p>
