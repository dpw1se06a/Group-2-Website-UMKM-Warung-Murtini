        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-header">
              <div class="row justify-content-between">
                <div class="col m-1">
                  <div class="input-group">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahDataMinuman">
                      Tambah Produk
                    </button>
                  </div>
                </div>
              ...
              <!-- MODAL TAMBAH -->
              <div class="modal fade" id="tambahDataMinuman" tabindex="-1" aria-labelledby="tambahDataMinumanLabel" aria-hidden="true">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#editDataMinuman<?= $row['id_minuman'] ?>"> Edit
                        </button>
                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#hapusDataMinuman<?= $row['id_minuman'] ?>">
                          Hapus
                        </button>
                      </td>
                    </tr>
                    ...
                    <!-- MODAL EDIT -->
                    <div class="modal fade" id="editDataMinuman<?= $row['id_minuman'] ?>" tabindex="-1" aria-labelledby="editDataMinuman<?= $row['id_minuman'] ?>Label" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h1 class="modal-title fs-5" id="editDataMinuman<?= $row['id_minuman'] ?>Label">
                              Edit <?= $row['nama_minuman'] ?>
                            </h1>
                          </div>
                          <form method="POST" action="page.php?mod=updateMinuman">
                            <div class="modal-body">
                              <input type="text" class="form-control" id="id_minuman" name="id_minuman" value="<?= $row['id_minuman'] ?>" hidden="true">
                              <div class="mb-3">
                                <label for="nama_minuman" class="form-label">Nama
                                  Minuman</label>
                                <input type="text" class="form-control" id="nama_minuman" name="nama_minuman" value="<?= $row['nama_minuman'] ?>">
                              </div>
                              <div class="mb-3">
                                <label for="deskripsi" class="form-label">Deskripsi</label>
                    ...
                    <!-- MODAL DELETE -->
                    <div class="modal fade" id="hapusDataMinuman<?= $row['id_minuman'] ?>" tabindex="-1" aria-labelledby="editDataMinuman<?= $row['id_minuman'] ?>Label" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h1 class="modal-title fs-5" id="editDataMinuman<?= $row['id_minuman'] ?>Label">
