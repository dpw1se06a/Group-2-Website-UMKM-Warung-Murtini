...
<body>
  ...
  $id_about = $judul = $konten = '';
  if (isset($_GET["edit"])) {
    $id = $_GET["edit"];
    $result = $conn->query("SELECT * FROM about WHERE id_about=$id");
            ...
            <div class="card">
              <div id="editForm" class="edit">
                <div class="container mt-5">
                  <h2>Form Edit</h2>
                  <form id="editFormAbout" method="post" action="about/edit/edit.php" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="judul">Judul</label>
                      <input type="text" class="form-control" id="judul" name="judul" value="<?php echo $judul; ?>" required>
                      <input type="hidden" class="form-control" id="judul" name="id_about" value="<?php echo $id_about; ?>" required>
                    </div>
                    <div class="form-group">
                      <label for="konten">Konten</label>
                      <textarea class="form-control" id="summernote" name="konten" value="" required><?php echo $konten; ?></textarea>
                    </div>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?= $row['konten'] ?></td>
                        <td>
                          <a href="page.php?mod=about&edit=<?php echo $row['id_about']; ?>" class="btn btn-primary btn-sm">Edit</a>
